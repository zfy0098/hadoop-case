...
public class SecondarySort {
    ...
    public static class SecondarySortReduce extends Reducer<IntPair, IntWritable, Text, IntWritable> {
        ...
        public void reduce(IntPair key, Iterable<IntWritable> values, Context context) throws IOException, InterruptedException {
            ...
            System.out.println("key.getFirst() : " + key.getFirst() + " , " + "key.getSecond():" + key.getSecond());
    ...
    public static void main(String[] args) throws Exception {
        ...
        String input = "hdfs://master:9000/sort/sort";
        String out = "hdfs://master:9000/sort/out";
